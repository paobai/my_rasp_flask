...
def processImage(path,file_path):
    '''
...
def main():
    git_path = os.path.join(CURRENT_SETTINGS.root_path,"save_picture","final_gif.gif")
    file_path = os.path.join(CURRENT_SETTINGS.root_path,"save_picture")
